...
class GuiStyle(Ui_MainWindow):
    ...
    def set_icon_color(self, color):
        ...
        self.serveradd_button.setIconSize(QSize(24, 24))
        self.serveredit_button.setIcon(qta.icon('ei.edit', color=color))
        self.serveredit_button.setIconSize(QSize(24, 24))
        ...
        self.actionSettings.setIcon(qta.icon('ph.gear-six', color=color))
    ...
    def set_font_size(self, size):
        ...
        self.earning_stats_tableWidget.setFont(font)
        self.earning_stats_tableWidget.horizontalHeader().setFont(font)
        # label Font size
        # login page labels
        ...
        self.add_without_seed_radiobutton.setFont(font)
        ...
        self.earningstat_table_label.setFont(font)
        self.earnings_search_button.setFont(font)
        self.earning_startdate_label.setFont(font)
        self.earning_start_dateTimeEdit.setFont(font)
        self.earning_start_dateTimeEdit.calendarWidget().setFont(font)
